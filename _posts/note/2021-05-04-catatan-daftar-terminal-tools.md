...
![gambar-htop]({{ page.assets | absolute_url }}/gambar-htop.png)
...
![gambar-gotop]({{ page.assets | absolute_url }}/gambar-gotop.png)
...
![gambar-gtop]({{ page.assets | absolute_url }}/gambar-gtop.png)
...
![gambar-vtop]({{ page.assets | absolute_url }}/gambar-vtop.png)
...
![gambar-ytop]({{ page.assets | absolute_url }}/gambar-ytop.png)
...
![gambar-bottom]({{ page.assets | absolute_url }}/gambar-bottom.png)
...
![gambar-bashtop]({{ page.assets | absolute_url }}/gambar-bashtop.png)
...
![gambar-bpytop]({{ page.assets | absolute_url }}/gambar-bpytop.png)
...
![gambar-glances]({{ page.assets | absolute_url }}/gambar-glances.png)
...
![gambar-nmon-01]({{ page.assets | absolute_url }}/gambar-nmon-01.png)

![gambar-nmon-02]({{ page.assets | absolute_url }}/gambar-nmon-02.png)
...
![gambar-vizex]({{ page.assets | absolute_url }}/gambar-vizex.png)
...
![gambar-iftop]({{ page.assets | absolute_url }}/gambar-iftop.png)
...
![gambar-htop]({{ page.assets | absolute_url }}/gambar-nethogs.png)
...
![gambar-gping]({{ page.assets | absolute_url }}/gambar-gping.png)
...
![gambar-prettyping]({{ page.assets | absolute_url }}/gambar-prettyping.png)
...
![gambar-wavemon-01]({{ page.assets | absolute_url }}/gambar-wavemon-01.png)

![gambar-wavemon-02]({{ page.assets | absolute_url }}/gambar-wavemon-02.png)

![gambar-wavemon-03]({{ page.assets | absolute_url }}/gambar-wavemon-03.png)
...
![gambar-tremc-01]({{ page.assets | absolute_url }}/gambar-tremc-01.png)

![gambar-tremc-02]({{ page.assets | absolute_url }}/gambar-tremc-02.png)

![gambar-tremc-03]({{ page.assets | absolute_url }}/gambar-tremc-03.png)

![gambar-tremc-04]({{ page.assets | absolute_url }}/gambar-tremc-04.png)
...
![gambar-lazygit]({{ page.assets | absolute_url }}/gambar-lazygit.png)
...
![gambar-tig-01]({{ page.assets | absolute_url }}/gambar-tig-01.png)

![gambar-tig-02]({{ page.assets | absolute_url }}/gambar-tig-02.png)
...
![gambar-periodic-table]({{ page.assets | absolute_url }}/gambar-periodic-table-tui.png)
...
![gambar-weechat-01]({{ page.assets | absolute_url }}/gambar-weechat-01.png)

![gambar-weechat-02]({{ page.assets | absolute_url }}/gambar-weechat-02.png)
...
![gambar-newsboat]({{ page.assets | absolute_url }}/gambar-newsboat.png)
...
![gambar-neomutt]({{ page.assets | absolute_url }}/gambar-neomutt.png)
...
![gambar-ranger]({{ page.assets | absolute_url }}/gambar-ranger.png)
