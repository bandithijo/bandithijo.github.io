...
2. Cek apakah pada direktori `/usr/share/themes/` terdapat direktori yang bernama sama seperti tema yang kita gunakan.
   ...
   drwxr-xr-x 11 root root NumixSolarizedDarkYellow 👈️
   drwxr-xr-x 11 root root NumixSolarizedLightBlue
   drwxr-xr-x 11 root root NumixSolarizedLightGreen
   drwxr-xr-x 11 root root NumixSolarizedLightYellow
   ```

   Atau, cek menggunakan File Manager,

   ![Gambar 1](https://i.postimg.cc/CKjv85C1/gambar-01.png)
...
1. Caranya cukup masuk ke dalam direktori tema dan cek apakah terdapat direktori `gtk-2.0/` dan `gtk-3.0/`.
   ...
   drwxr-xr-x 2 root root gtk-2.0 👈️
   drwxr-xr-x 2 root root gtk-3.0 👈️
   ...
   drwxr-xr-x 2 root root xfwm4
   ```

   Atau, cek menggunakan File Manager,

   ![Gambar 2](https://i.postimg.cc/XvmCnkBB/gambar-02.png)
...
```bash
!filename: $HOME/.gtkrc-2.0
# DO NOT EDIT! This file will be overwritten by LXAppearance.
# Any customization should be done in ~/.gtkrc-2.0.mine instead.

include "/home/bandithijo/.gtkrc-2.0.mine"
gtk-theme-name="NumixSolarizedDarkYellow" 👈️
...
![Gambar 3](https://i.postimg.cc/257SKdFf/gambar-03.png)
...
![Gambar 4](https://i.postimg.cc/htBLQBs4/gtk2.gif)
...
```bash
!filename: $HOME/.config/gtk-3.0/settings.ini
[Settings]
...
![Gambar 5](https://i.postimg.cc/Ssq3g3mm/gtk3.gif)
