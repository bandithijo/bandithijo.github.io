...
assets: "/assets/images/posts/blog/2020/2020-06-16-membuat-web-scraper-dengan-ruby-copy-from-csv"
author: "BanditHijo"
category: "blog"
...
Berdasarkan rekomendasi dari jawaban yang diberikan pada [dba.stackexchange: Cannot read from /tmp with PostgreSQL COPY](https://dba.stackexchange.com/questions/114568/cannot-read-from-tmp-with-postgresql-copy-but-able-to-read-the-same-file-from) --saya mendemonstrasikan pada dokumentasi video di bawah--.
...
> INFO
> 
> Apabila direktori `/data/` yang berlaku sebagai temp direktori sudah tidak digunakan, kita dapat meng-*unmount* dengan cara,
> ```
