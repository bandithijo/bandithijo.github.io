...
![Gambar 18]({{ page.assets | absolute_url }}/gambar_18.png)

Hasilnya akan seperti gambar di bawah.

![Gambar 19]({{ page.assets | absolute_url }}/gambar_19.png)
...
![Gambar 20]({{ page.assets | absolute_url }}/gambar_20.png)
...
![Gambar 21]({{ page.assets | absolute_url }}/gambar_21.png)

Selanjutnya pilih **Next**.

![Gambar 22]({{ page.assets | absolute_url }}/gambar_22.png)

Pilih **Next**.

Pilih _Database Scheme_ yang kita buat.

![Gambar 23]({{ page.assets | absolute_url }}/gambar_23.png)

Pilih **Next**.

![Gambar 24]({{ page.assets | absolute_url }}/gambar_24.png)

Pilih **Next**.

![Gambar 25]({{ page.assets | absolute_url }}/gambar_25.png)

Pilih **Execute > Next > Close**.

Nanti akan terbuka _tab EER Diagram_.

![Gambar 26]({{ page.assets | absolute_url }}/gambar_26.png)

![Gambar 27]({{ page.assets | absolute_url }}/gambar_27.png)
...
![Gambar 28]({{ page.assets | absolute_url }}/gambar_28.png)

Nanti akan terbuka _window_ baru seperti di bawah.

![Gambar 29]({{ page.assets | absolute_url }}/gambar_29.png)
...
![Gambar 30]({{ page.assets | absolute_url }}/gambar_30.png)

Pilih **Next >**.

Periksa bagian **Columns :**, apakah sudah sesuai dengan kategori dari masing-masing kolom / _fields_.

![Gambar 31]({{ page.assets | absolute_url }}/gambar_31.png)

Pilih **Next >**.

![Gambar 32]({{ page.assets | absolute_url }}/gambar_32.png)

Pilih **Next >**.

Nah, kalo sudah menampilkan seperti di bawah, proses import data artinya telah sukses.

![Gambar 33]({{ page.assets | absolute_url }}/gambar_33.png)
...
![Gambar 34]({{ page.assets | absolute_url }}/gambar_34.png)
...
![Gambar 38]({{ page.assets | absolute_url }}/gambar_38.png)
...
![Gambar 39]({{ page.assets | absolute_url }}/gambar_39.png)

Kemudian, _export_ ke dalam format **.csv**, dengan menekan tombol **Export**.

![Gambar 40]({{ page.assets | absolute_url }}/gambar_40.png)
...
![Gambar 41]({{ page.assets | absolute_url }}/gambar_41.png)

Akan memunculkan hasil seperti gambar di bawah.

![Gambar 42]({{ page.assets | absolute_url }}/gambar_42.png)

Kita perlu menghapus baris pertama karena bukan berisi _record_ yang kita perlukan.

![Gambar 43]({{ page.assets | absolute_url }}/gambar_43.png)

Dan akan menghasilkan isi tabel seperti gambar di bawah.

![Gambar 44]({{ page.assets | absolute_url }}/gambar_44.png)
