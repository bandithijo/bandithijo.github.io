...
1. **Download Snapshot from AUR**
   ...
   _Download snapshot_ dari Cisco Packet Tracer 7.1.1 yang tersedia di AUR pada tautan ini >> [Download Snapshot](https://aur.archlinux.org/cgit/aur.git/snapshot/packettracer.tar.gz).
...
3. **Download Latest Cisco Packet Tracer from NetAcad**
   ...
   > 
   > Silahkan melakukan download dengan account NetAcad masing-masing yaa. [NetAcad.com](http://netacad.com/)

   > INFO
   > 
   > Kabar gembira!
   > 
   > Bagi teman-teman yang belum mempunyai akun netacad untuk mendownload Cisco Packet Tracer, dapat terlebih dahulu membaca instruksi yang diberikan oleh mas **fathurhoho** pada tautan berikut ini >> [Cara Mendaftar Akun Netacad](https://ngonfig.net/akun-netacad.html)
