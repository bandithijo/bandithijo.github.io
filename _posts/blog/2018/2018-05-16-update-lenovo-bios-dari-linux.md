...
![Banner]({{ site.url }}{{ page.assets }}/banner_post_12.png)
...
![Gambar 7]({{ site.url }}{{ page.assets }}/gambar_07.gif)
...
![Gambar 5]({{ site.url }}{{ page.assets }}/gambar_05.gif)
...
![Gambar 6]({{ site.url }}{{ page.assets }}/gambar_06.gif)
