...
![Banner]({{ page.assets | absolute_url }}/banner_post_22.png)
...
![Gambar 1]({{ page.assets | absolute_url }}/gambar-1.png)
...
![Gambar 2]({{ page.assets | absolute_url }}/gambar-2.png)
...
![Gambar 3]({{ page.assets | absolute_url }}/gambar-3.png)
...
![Gambar 4]({{ page.assets | absolute_url }}/gambar-4.png)
...
![Gambar 5]({{ page.assets | absolute_url }}/gambar-5.png)
...
![Gambar 6]({{ page.assets | absolute_url }}/gambar-6.png)

Gambar 6. Tab Ekstension

Saya belum pernah sama sekali menggunakan tab Ekstension ini.

![Gambar 7]({{ page.assets | absolute_url }}/gambar-7.png)
...
![Voko 1]({{ page.assets | absolute_url }}/voko-1.gif)

Hasilnya seperti ini.

![Voko 2]({{ page.assets | absolute_url }}/voko-2.gif)
